  ...
  return (
    <div className="bg-white">
      <section className="h-screen w-full relative">
        ...
        <div className="absolute left-[28%] right-[28%] top-[40%] text-white font-semibold text-2xl z-20 text-center tracking-wide">
          <h1>
            Join us in creating a brighter future for Sri Lanka. With a focus on
            innovation, inclusivity, and sustainability, Indira Kalugalla is
            committed to transforming our nation and empowering every citizen.
          </h1>
        </div>
        ...
        <div className="absolute -bottom-20 left-0 right-0 w-full flex items-center justify-center">
          <div className="flex items-center">
            <div className="h-56 w-auto bg-darkRed rounded-tl-lg rounded-bl-lg -skew-x-12 flex flex-col items-center justify-center text-white p-12">
              <h1 className="font-bold text-3xl text-center">
                Join Our <br /> Movement
              </h1>
              <p className="uppercase text-center mt-4">
                Help fulfill our promise to <br />
                <span className="font-bold ">Make SRI LANKA Great!</span>
              </p>
            </div>
            <div className="h-36 w-auto flex items-center bg-yellow -skew-x-12 rounded-tr-lg rounded-br-lg p-6">
              <div className="bg-white rounded-md p-4 flex items-center">
                <p className="uppercase mr-44">Email</p>
                <div className="w-0.5 h-4 mr-4 bg-black"></div>
                <p className="uppercase mr-44">Phone</p>
                <img src="/images/play.png" className="w-12 h-12" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="p-4 text-center w-full mx-auto max-w-6xl mt-40">
        <h1 className="mb-4 font-bold text-2xl text-darkRed">
          Welcome to Indira Kalugalla
        </h1>
        <p className="text-md font-normal mb-16">
          Join us in building a prosperous nation. Indira Kalugalla, a dedicated
          social activist and the only female candidate in the upcoming
          presidential election, is committed to leading Sri Lanka towards a
          future of prosperity and growth. Her campaign focuses on innovation,
          inclusivity, and sustainability to ensure a brighter future for all
          Sri Lankans.
        </p>
        ...
        <p className="text-md font-normal mb-16">
          ...
          background in public service and social activism, she is committed to
          addressing contemporary challenges with innovative solutions.
        </p>
      </section>
      ...
      <section className="p-4 text-center w-full mx-auto max-w-6xl">
        ...
        <p className="text-md font-normal mb-16">
          ...
          our nation's prosperity. We are committed to fostering national unity
          and harmony among all ethnic and religious groups. Through sustainable
          economic development, technological advancement, and comprehensive
          education reforms, we aim to drive progress and build a vibrant,
          forward-thinking Sri Lanka. Together, we will create a nation where
          every individual is valued, every community is included, and our
          shared{" "}
      ...
      <section className="relative bg-darkRed h-auto w-full pt-16">
        <div>
          ...
          <img
            ...
            alt="rsquo"
            className="absolute z-10 top-[1500px] bottom-0 left-[90%] right-10 w-36 h-auto object-cover"
          />
        </div>
            ...
            <div className="bg-yellow shadow-2xl w-full">
              ...
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <div className="text-white text-center">
                  ...
                  <p className="uppercase px-8">
                    Leveraging technology to enhance governance and connect with
                    citizens
                  </p>
                </div>
              </div>
        ...
        <div className="cursor-pointer">
          ...
          <div className="text-center">
            ...
            <p className="font-semibold uppercase">
              ...
              cohesive and harmonious society where diversity is celebrated, and
      ...
      <section className="bg-darkRed py-16">
        <div className="text-center px-28">
          <p className="text-xl text-yellow font-semibold">
            ...
            well-being of our citizens. Together, these objectives will pave the
            way for a vibrant, forward-thinking, and resilient Sri Lanka.
          </p>
        </div>
